...
const showCourses=({UpcomingData})=>{
    debugger

    if(UpcomingData['latest']){
        console.log('courseData===>',UpcomingData);
        const list=UpcomingData.latest.map((item)=><MovieDetailNoBooking className={"col-xs-6 col-md-3"}
